...
router.post('/:course_id/lesson/create', verifyToken, verifyCourseOwner, verifyTeacher, uploadThumbnail, createLesson)
router.put('/:course_id/lesson/update/:lesson_id', verifyToken, verifyTeacher, verifyCourseOwner, uploadThumbnail, updateLesson)
